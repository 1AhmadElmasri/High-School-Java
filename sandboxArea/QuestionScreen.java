...
public class QuestionScreen extends javax.swing.JFrame {
    ...
    public void questionSetter(Element root) {
        if (position < 5) {
            ...
            answerList = new int[4];
            question = root.getChildElements().get(questionList[position]);

            holderOfValue = question.getFirstChildElement("name").getValue();
            jLabelQuestion.setText(holderOfValue);
            
            ArrayUtil.generateRandomArrayNoDuplicates(answerList, 0, 4);
            ArrayUtil.displayArray(answerList);
            jToggleButtonAnswer1.setText(question.getFirstChildElement("answerList").getChildElements().get(answerList[0]).getValue());
            jToggleButtonAnswer2.setText(question.getFirstChildElement("answerList").getChildElements().get(answerList[1]).getValue());
            jToggleButtonAnswer3.setText(question.getFirstChildElement("answerList").getChildElements().get(answerList[2]).getValue());
            jToggleButtonAnswer4.setText(question.getFirstChildElement("answerList").getChildElements().get(answerList[3]).getValue());
        }else{
